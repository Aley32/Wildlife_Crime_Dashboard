...
These figures depict the countries where most incidents occur and the distribution of the different types of incidents. China and India have the highest demand for illegal wildlife products and are also home to a lot of high demand species. Most incident types are classified as a seizure and the second most common incident type is poaching / illegal harvesting.
...
Most incidents did not report the type of transport used for smuggling, however, the most common was some kind of vehicle. The number of arrests correlates with number of incidents in each country, with India in the lead, followed by a large decrease in arrests. This figure portrays the importance of increasing law enforcement and limiting current corruption as arrests are relatively low compared to the number of seizures occurring. Many arrests lead to confiscation, imprisonment, or fines, all of which tend to be relatively inconsequential to those committing the crimes.
